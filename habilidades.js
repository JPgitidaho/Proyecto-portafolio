document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-center items-center max-w-4xl mx-auto">
    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-html;">
    ...
    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-css;">
    ...
    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-js;">
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"
        alt="JavaScript" class="h-12 mx-auto mb-4">
      <p class="text-lg">JavaScript</p>
    </div>

    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-tailwind;">
      <img src="https://raw.githubusercontent.com/tailwindlabs/tailwindcss/master/.github/logo-light.svg"
        alt="Tailwind" class="h-12 mx-auto mb-4">
      <p class="text-lg">Tailwind</p>
    </div>

    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-python;">
    ...
    <div class="bg-gray-800 p-6 rounded-lg skill-card opacity-0 transform translate-y-6 transition duration-700"
      style="animation-name: pulse-csharp;">
  ...
  <a href="./documentos/Juanita_Perez.pdf" download
     class="inline-block px-6 py-3 bg-yellow-400 text-gray-900 font-semibold rounded-xl shadow-md hover:bg-yellow-300 transition duration-300 ease-in-out">
  ...
  document.getElementById("habilidades-container").innerHTML = habilidadesHTML;
});
